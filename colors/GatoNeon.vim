  ...
  let s:guishade0 = "#0a0a15"
  let s:guishade1 = "#303039"
  let s:guishade2 = "#45454d"
  let s:guishade3 = "#5b5b51"
  let s:guishade4 = "#606065"
  let s:guishade5 = "#868689"
  let s:guishade6 = "#9b9b9d"
  let s:guishade7 = "#b1b1b1"
  let s:guiaccent0 = "#ff00aa"
  let s:guiaccent1 = "#ff74d2"
  let s:guiaccent2 = "#ff8700"
  let s:guiaccent3 = "#aaee00"
  let s:guiaccent4 = "#00ffed"
  let s:guiaccent5 = "#0077ff"
  let s:guiaccent6 = "#00ffed"
  let s:guiaccent7 = "#bb00ff"
  ...
  let s:ctermshade6 = 245
  let s:ctermshade7 = 247
  let s:ctermaccent0 = 199
  let s:ctermaccent1 = 212
  let s:ctermaccent2 = 214
  let s:ctermaccent3 = 154
  let s:ctermaccent4 = 51
  let s:ctermaccent5 = 33
  let s:ctermaccent6 = 51
  let s:ctermaccent7 = 165
  ...
  let s:guishade0 = "#a1a1a1"
  let s:guishade1 = "#8b8b8e"
  let s:guishade2 = "#76767a"
  let s:guishade3 = "#606067"
  let s:guishade4 = "#4b4b54"
  let s:guishade5 = "#353541"
  let s:guishade6 = "#20202d"
  let s:guishade7 = "#0a0a1a"
  ...
  let s:ctermshade0 = 247
  let s:ctermshade1 = 245
  let s:ctermshade2 = 243
  let s:ctermshade3 = 241
  let s:ctermshade4 = 239
  let s:ctermshade5 = 237
  let s:ctermshade6 = 235
  ...
  exec "hi Comment guifg=".s:guishade2." gui=italic"
  exec "hi Comment ctermfg=".s:ctermshade2." cterm=italic"
